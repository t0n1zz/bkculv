            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                @foreach($datas as $data)
                    <tr>
                        ...
                        @if($data->id > 1)
                            @if($data->status == 0)
                                <td><a href="#" class="btn btn-default modal2"
                                       name="{{$data->id}}">Tidak Aktif</a</td>
                            @elseif($data->status == 1)
                                <td><a href="#" class="btn btn-warning modal2"
                        ...
                        <td><a class="btn btn-primary" href="{{route('admins.'.$kelas.'.edit',
                                array($data->id))}}">
                                <i class="fa fa-pencil"></i></a></td>
...
<div class="modal fade" id="modal2show" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   {{ Form::open(array('route' => array('admins.'.$kelas.'.update_status'))) }}
